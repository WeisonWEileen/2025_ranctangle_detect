...
def find_and_complete_rectangle(image):
    ...
    # 显示结果
    cv2.imshow("Completed Rectangle", out)
    cv2.waitKey(0)
...
# 加载图像
image = cv2.imread('/home/charlie/robocon/data/OIP-C.jpg 2')
if image is not None:
    find_and_complete_rectangle(image)
else:
